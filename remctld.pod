...
Limit logging of command arguments to at most the first I<limit>
arguments.  This is a hack to avoid logging the arguments of commands that
take privileged information, and will be removed again once the
configuration file syntax is smart enough to allow this to be configurable
