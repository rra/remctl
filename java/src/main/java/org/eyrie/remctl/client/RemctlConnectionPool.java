 ...
 * 
 * <p>
 * All commands sent using the pool should be sent with keep alive=true to prevent the server from closing the
 * connection. A server may close a connection after a set amount of time, so set your max idle timeouts to be less that
 * the server timeout
 * </p>
 * 
 */
public class RemctlConnectionPool extends GenericObjectPool {
     ...
     *            The RemctlConnectionFactory that will create new connections, and validate existing ones.
     */
